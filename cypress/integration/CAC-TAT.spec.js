  ...
  beforeEach(function() {
    ...
    cy.title().should('be.equal','Central de Atendimento ao Cliente TAT')
     ...
     it('preenche os campos obrigatórios e envia o formulário',function(){
      const longText = 'teste de função com texto prolongado pra melhor execução do delay.'
     ...
     it('preenche e limpa os campos nome, sobrenome, email e telefone',function(){
      ...
      cy.get('#lastName')
        .type('Franco Jorge')
        .should('have.value','Franco Jorge')
        .clear()
        .should('have.value','')

      cy.get('#email')
        .type('rshina@hotmail.com')
        .should('have.value','rshina@hotmail.com')
        .clear()
        .should('have.value','')

      cy.get('#phone')
        .type('988427489')
        .should('have.value','988427489')
        .clear()
        .should('have.value','')
